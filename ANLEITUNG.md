...
|-----|---------|--------------|
| 1 | [🏗️ Systemüberblick](#️-systemüberblick) | Architektur und Mandantenfähigkeit |
...
|------------|--------------|
| ⚛️ Frontend | React-basierte Single-Page-Application |
| 🖥️ Backend | Express.js REST-API |
| 🗄️ Datenbank | PostgreSQL mit Drizzle ORM |
...
| ⏱️ Timeout | Netzwerkproblem | Firewall-Regeln prüfen |
...
- ✏️ Nachträglich: Ticket bearbeiten > Kontakt hinzufügen
...
- ⚠️ Offene SLA-Verletzungen
- 💻 Verknüpfte Assets

### 🏷️ Vertriebs- und Servicetickets
...
- 🛡️ Security-Events eines Benutzers
...
| ⚠️ `expired` | Zertifikat abgelaufen |
...
- ⚙️ Konfigurierbar in den TLS-Einstellungen
- 🔔 Bei Fehlern: Benachrichtigung an Admin

> ⚠️ **Hinweis:** Die TLS-Verwaltung erfordert einen eigenen Server. In Hosting-Umgebungen wie Replit ist die HTTP-01 Challenge nicht möglich.

---

## 🎨 Branding und Mandantenanpassung

### 🖼️ Logos und Farben setzen

**🧭 Navigation:** Einstellungen > Branding

**📷 Logo-Typen:**
- 🖼️ Hauptlogo (für Header)
...
| 🗄️ Datenbankoptimierung | Quartalsweise |
...
- ©️ Copyright-Hinweise beizubehalten
...
| [NOTICE](./NOTICE) | ©️ Copyright-Hinweis |
